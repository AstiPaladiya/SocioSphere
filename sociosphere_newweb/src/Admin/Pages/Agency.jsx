...
const columns = [
    ...
    { id: 'agencyTypeName', label: 'Agency Name', minWidth: 200 }, // id matches data, label is what you want to show
    { id: 'status', label: 'Status', minWidth: 100 },
    { id: "edit", label: "Edit", minWidth: 100 },
];
const reccolumns = [
    { id: 'id', label: '#'},
    { id: 'agencytype', label: 'Agency Type' },
    { id: 'contactPersonName', label: 'Person name' },
    // { id: 'email', label: 'Email-Id', minWidth: 100 },
    // { id: 'location', label: 'Location', minWidth: 200 },
    { id: 'contactNo', label: 'Phone no' },
