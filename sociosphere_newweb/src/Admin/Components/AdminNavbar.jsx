        ...
        <List>
          ...
          <ListItemButton
            ...
            to="/Admin/Maintenance"
                    selected={location.pathname === "/Admin/Maintenance"}
            sx={{ ...(location.pathname === "/Admin/Maintenance") ? selectedItemStyle : {} }}
            >
            <ListItemIcon sx={{ color: "inherit" }}>
              <CurrencyRupeeIcon />
            </ListItemIcon>
          ...
          <ListItemButton onClick={handleComplainClick}   sx={{
              backgroundColor:
                ["/Admin/Complain", "/Admin/AllComplain"].includes(location.pathname)
                  ? "rgba(243, 243, 243, 0.56)"
                  : "inherit", // soft light indigo
              backdropFilter:
                ["/Admin/Complain", "/Admin/AllComplain"].includes(location.pathname)
            ...
            <ListItemText primary="Complain" sx={{ color: "inherit", cursor: "pointer" }} />
            {complainOpen ? <ExpandLess /> : <ExpandMore />}
          </ListItemButton>
          ...
          >
            <List component="div" disablePadding>
              <ListItem
                ...
                component={Link}
                to="/Admin/Complain"
                 selected={location.pathname === "/Admin/Complain"}
                sx={{
                  pl: 4, color: "inherit",
                  ...(location.pathname === "/Admin/Complain" ? selectedItemStyle : {})
                }}

              >
                <ListItemText
                  primary="- Complain Type"
                  sx={{ color: "black" }}
                />
              </ListItem>
              <ListItem
                button
                component={Link}
                to="/Admin/AllComplain"
                 selected={location.pathname === "/Admin/AllComplain"}
                sx={{
                  pl: 4, color: "inherit",
                  ...(location.pathname === "/Admin/AllComplain" ? selectedItemStyle : {})
                }}
          ...
          <ListItemButton
            component={Link}
            to="/Admin/Expenses"
             selected={location.pathname === "/Admin/Expenses"}
            sx={{ ...(location.pathname === "/Admin/Expenses") ? selectedItemStyle : {} }}
            >
            <ListItemIcon sx={{ color: "inherit" }}>
              <FaMoneyBillTrendUp />
            </ListItemIcon>
          ...
          <ListItemButton
            component={Link}
            to="/Admin/Agency"
              selected={location.pathname === "/Admin/Agency"}
            sx={{ ...(location.pathname === "/Admin/Agency") ? selectedItemStyle : {} }}
            >
            <ListItemIcon sx={{ color: "inherit" }}>
              <RecentActorsIcon />
            </ListItemIcon>
          ...
          <ListItemButton
            component={Link}
            to="/Admin/Visiter"
              selected={location.pathname === "/Admin/Visiter"}
            sx={{ ...(location.pathname === "/Admin/Visiter") ? selectedItemStyle : {} }}>
            <ListItemIcon sx={{ color: "inherit" }}>
