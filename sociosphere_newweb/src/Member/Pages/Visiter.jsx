...
const allVcolumns = [
    { id: 'id', label: '#' },
    { id: 'image', label: 'Image' },         // changed
    { id: 'name', label: 'Visitor Name' },         // changed
    { id: 'phoneNo', label: 'Phone no' },         // changed
    { id: "entryDate", label: "Entry Date", minWidth: 110 },      // changed
    { id: "entryTime", label: "Entry Time" },
    { id: "exitDate", label: "Exit Date", minWidth: 110 },      // changed
    { id: "exitTime", label: "Exit Time" },       // changed
    { id: "watchmen", label: "Watchmen" },         // changed
];
export default function Visiter() {
    ...
    const fetchAllVisiter = async () => {
        try {
            const res = await axios.get(`${API_BASE_URL}/Visiter/getAllVisiterByMember`, {
                headers: {
                    memberId: user
                }
            });
            ...
            <Container>
                ...
                <Box sx={{ borderBottom: 1, borderColor: 'lightgrey', bgcolor: "whitesmoke" }}>
                    <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                        ...
                        <Tab label="History" {...a11yProps(0)} sx={{ fontSize: '14px' }} />
                    </Tabs>
                </Box>
                {/* today today visiter */}
                                                    ...
                                                    <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                                                        ...
                                                        <TableCell align="center"><Avatar
                                                            sx={{
                                                                ...
                                                                backgroundColor: "#C4DEF6", // Background color
                                                                color: "#1976d2", // Text color
                                                                fontSize: "20px", // Font size for initials
                                                                // border: "1px solid #1976d2", // Add a border
                                                                boxShadow: "0 2px 8px rgba(0, 0, 0, 0.15)", // Add a shadow
                                                            }}
                                                        >
                                                            {row.photo}
                                                        </Avatar></TableCell>
