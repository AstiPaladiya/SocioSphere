...
public partial class SociosphereContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CommitteMemberRecord>(entity =>
        {
            entity.ToTable("committe_member_record");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.CommittieTypeId).HasColumnName("committie_type_id");
            entity.Property(e => e.CreatedAt)
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.CommittieType).WithMany(p => p.CommitteMemberRecords)
                .HasForeignKey(d => d.CommittieTypeId)
                .HasConstraintName("FK_committe_member_record_society_committe_master");

            entity.HasOne(d => d.User).WithMany(p => p.CommitteMemberRecords)
        ...
        modelBuilder.Entity<SocietyCommitteMaster>(entity =>
        {
            entity.ToTable("society_committe_master");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.CommitteName)
                .HasMaxLength(300)
                .IsUnicode(false)
                .HasColumnName("committe_name");
            entity.Property(e => e.CreatedAt)
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            entity.Property(e => e.Description)
        ...
        modelBuilder.Entity<UserMaster>(entity =>
        {
            ...
            entity.Property(e => e.CommiteMemberId).HasColumnName("commite_member_id");
            entity.Property(e => e.CreatedAt)
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.CommiteMember).WithMany(p => p.UserMasters)
                .HasForeignKey(d => d.CommiteMemberId)
                .HasConstraintName("FK_user_master_committe_member_record");
